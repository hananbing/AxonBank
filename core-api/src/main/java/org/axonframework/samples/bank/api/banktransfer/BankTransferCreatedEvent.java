...
public class BankTransferCreatedEvent {
  ...
  public BankTransferCreatedEvent() {
  }

  public BankTransferCreatedEvent(String bankTransferId, String sourceBankAccountId, String destinationBankAccountId, long amount) {
